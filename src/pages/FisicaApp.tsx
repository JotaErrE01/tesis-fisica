    ...
    <>
      ...
      <div className="h-screen">
        ...
        <div className='text-center fixed mx-auto left-0 right-0 top-5 font-semibold w-4/5'>
          <h1 id='title' className='text-[0.75rem] sm:text-xl md:text-[1.4rem] lg:text-[1.6rem] text-purple-800 font-karla leading-loose border-2 border-purple-400 border-solid py-2 px-1 rounded-lg'>Herramientas Web en el Proceso de Enseñanza y Aprendizaje en la Asignatura de Física</h1>
        </div>
        ...
        <button
          className="fixed bg-clip-text text-transparent bg-gradient-to-t from-yellow-400 via-orange-600 to-rose-600 border-2 border-orange-500 font-karla rounded-lg px-6 py-3 hover:bg-clip-padding hover:via-orange-500 hover:text-white transition-all duration-300 ease-out bottom-20 left-10 text-xl md:text-3xl lg:top-40 lg:right-20 lg:bottom-auto lg:left-auto hover:border-transparent"
          onClick={() => {
            navigate('/inicio');
          }}
        >Ingresar</button>
